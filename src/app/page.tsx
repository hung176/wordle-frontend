  ...
  return (
    <main className="flex flex-col justify-center items-center">
      ...
      <div className="flex justify-between">
        <button className="w-40 mobile:w-44 h-12 rounded-full border-2 border-gray-600 mr-4" onClick={toggleHowToPlay}>
          How to play
        </button>
        <button className="w-40 mobile:w-44 h-12 rounded-full text-white bg-black" onClick={handleStartGame}>
          Play
        </button>
      </div>
