...
const Setting: React.FC<SettingProps> = ({ settings, timer, setSettings, toggle, isDisabledSetting }) => {
  ...
  const isChallengeMode = session?.challengeType === ChallengeType.CHALLENGE;
  const isDailyMode = session?.challengeType === ChallengeType.DAILY;
  const isInfiniteMode = session?.challengeType === ChallengeType.INFINITE;
  ...
  return (
    <div className="w-[100%] flex flex-col justify-center items-center">
      ...
      <div className="w-[100%]">
        <div
          className={`p-3 flex flex-col border-b border-gray-200 ${
            isDisabledSetting || isChallengeMode ? 'opacity-50' : 'opacity-100'
          }`}
        >
          ...
          <div className={`flex items-center justify-between`}>
            ...
            <label className="relative inline-flex cursor-pointer items-center">
              <input
                ...
                disabled={isDisabledSetting || isChallengeMode}
